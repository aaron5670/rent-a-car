        ...
        <div class="container">
            <?PHP
                if(isset($_REQUEST['brand'])){
                    ...
                    echo "<h2>U heeft gezocht op: $brand</h2>";
                }
            ?>
            ...
            <div class="row">
                ...
                if(isset($_REQUEST['brand'])){
                    $brand = $_REQUEST['brand'];
                    // Filtered car data
                    $query=mysqli_query($conn,"SELECT * FROM cars WHERE brand = '$brand'");
                    while($ft = mysqli_fetch_array($query)) {
                        // Link to the product page
                        $id = $ft['car_id'];
                ?>
                    <div class="col-md-4"><a href="detailpagina.php?car_id=<?php echo $id ?>"><img class="img-responsive" src="<?php if ($ft['image_name'] == NULL){ echo "http://placehold.it/350x200/333333/FFFFFF";} else { ?>car_images/<?php echo $ft['image_name'];}?>"></a>
                        ...
                        <p class="text-center description" style="font-size:15px;"><?php echo $ft['description']; ?>
                            <a href="huren.php?car_id=<?php echo $id ?>"><button class="btn btn-primary" type="submit" style="width:288px;margin:5px;">Reserveer nu!</button></a></p>
                    </div>
                    <?php
                    }
                }else {
