...
<body>
    ...
    <div class="login-clean">
        ...
        <form action="include/userAccount.php" method="post">
            ...
            <input type="submit" name="loginSubmit" style="margin-top:-5px; background-image: linear-gradient(to bottom,#337ab7 0,#265a88 100%);" class="btn btn-primary" value="Inloggen">
            <span class="text-success align-middle">
                <?php echo !empty($statusMsg)?'<i class="fa fa-close"></i><p class="'.$statusMsgType.'">'.$statusMsg.'</p>':''; ?>
            </span>
            <h3>Nieuwe klant?</h3>
            <p>Maak eerst een account aan om een auto te kunnen reserveren.</p>
            <a href="registreren.php"><button style="margin-top:-5px; background-image: linear-gradient(to bottom,#337ab7 0,#265a88 100%);" class="btn btn-primary" type="button">Registreer hier</button></a>
        </form>
    </div>
