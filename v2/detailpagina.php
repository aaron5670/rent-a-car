        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <h3>per dag</h3><a href="huren.php?car_id=<?php echo $id ?>"><button class="btn btn-primary" type="submit" style="width:290px;margin:30px;padding:13px;">Reserveer nu!</button></a></div>
            </div>
        </div>
    </div>
    <div>
